...
class HabitDatabase {
  ...
  void loadHeatMap() {
    ...
    // go from start date to today and add each percetages to the dataset
    // "PERCENATGE_SUMMARY_yyyymmdd" will be the key in the database
    for(int i=0;i<daysInBetween+1;i++){
      ...
      // split the datetime up like below so it doesn;t worry about the hours/min/secs etc.
